...
# Generation Time: 2021-01-27 13:08:26 +0000
# ************************************************************
...
CREATE TABLE `copy_config` (
  ...
  `is_ascii` tinyint(4) DEFAULT NULL,
...
LOCK TABLES `copy_config` WRITE;
/*!40000 ALTER TABLE `copy_config` DISABLE KEYS */;

INSERT INTO `copy_config` (`id`, `inter_big`, `inter_tdk_big`, `inter_tdk_entity`, `inter_template`, `is_inpage_word`, `is_ascii`, `rand_tdk`, `preg_title`, `preg_keywords`, `preg_description`, `base_domain_redirect`, `inter_word_num`, `inter_side_link_num`)
VALUES
	(1,0,0,0,0,0,0,0,'{keyword} - {other1} - {name}网','','',1,3000,5);

/*!40000 ALTER TABLE `copy_config` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `safe_config` (`id`, `close_sites`, `close_post`, `uri_length`, `close_ips`)
VALUES
	(1,0,1,30,'192.168.*.*,110.110.110.110');
...
CREATE TABLE `sites` (
  ...
  `cache_file` varchar(128) DEFAULT '',
...
CREATE TABLE `system_config` (
  ...
  `auto_clean` tinyint(4) NOT NULL,
  `auto_check` tinyint(4) NOT NULL,
...
INSERT INTO `system_config` (`id`, `check_spider_ua`, `check_spider_ip`, `auto_update`, `auto_clean`, `auto_check`, `pc_landing`, `mobile_landing`, `error_page`, `landing_page`, `js_coding`)
VALUES
