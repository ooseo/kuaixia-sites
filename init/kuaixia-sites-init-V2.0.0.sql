...
INSERT INTO `system_config` (`id`, `close_sites`, `close_post`, `check_spider_ua`, `check_spider_ip`, `pc_landing`, `mobile_landing`, `uri_length`, `error_page`, `landing_page`, `close_ips`)
VALUES
